...
l10n_keys! {
    ...
    SettingsAgentCrush,
    SettingsAgentCommandCode,
    SettingsAgentMiniMaxCode,
    ...
    SettingsSearchCommandCodeKeywords,
    SettingsSearchMiniMaxCodeKeywords,
...
mod tests {
    ...
    fn every_key_is_translated_in_every_locale() {
        ...
        const KEPT_IN_ENGLISH: &[L10nKey] = &[
            ...
            L10nKey::SettingsAgentCommandCode,
            L10nKey::SettingsAgentMiniMaxCode,
